...
std::uint32_t fin::math::integers::byteSwap(const std::uint32_t &x) {
#if defined(_MSC_VER)
...
std::uint16_t fin::math::integers::byteSwap(const std::uint16_t &x) {
#if defined(_MSC_VER)
...
std::int16_t fin::math::integers::byteSwap(const std::int16_t &x) {
    std::uint16_t val_u = *(std::uint16_t *) &x;  //Convert to unsigned
    val_u = byteSwap(val_u);                         //Convert to big endian
    return *(std::int16_t *) &val_u;              //Make it signed
}

std::uint64_t fin::math::integers::byteSwap(const std::uint64_t &x) {
#if defined(_MSC_VER)
...
std::int64_t fin::math::integers::byteSwap(const int64_t &x) {
